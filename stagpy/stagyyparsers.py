...
def read_geom_h5(xdmf_file: Path, snapshot: int, xdmf_root_input = None) -> Tuple[Dict[str, Any], Element]:
    """Extract geometry information from hdf5 files.

    Args:
        xdmf_file: path of the xdmf file.
        snapshot: snapshot number.
        xdmf_root_input: TGM: neeeded for 'fast track' (speeds up reading of files)
    Returns:
