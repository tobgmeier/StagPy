...
TIME = OrderedDict((
    ...
    ('etamin', Vart('Min viscosity', 'Viscosity', 'Pa$cdot$s')),
    ('etamean', Vart('Viscosity', 'Viscosity', 'Pa$cdot$s')),
    ('etamax', Vart('Max viscosity', 'Viscosity', 'Pa$cdot$s')),
